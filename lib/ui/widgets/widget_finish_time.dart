...
class DurationFeildWidget extends StatefulWidget {
  String hint;
  ...
  @override
  _DurationFeildWidgetState createState() => _DurationFeildWidgetState();
}

class _DurationFeildWidgetState extends State<DurationFeildWidget> {
