...
class BookingWeeklyReadResponse {
  String address;
  ...
  BookingWeeklyReadResponse.fromJson(Map<String, dynamic> json) {
...
class BookingWeeklyListResponse {
  List<BookingWeeklyReadResponse> values = [];

  BookingListResponse() {
    values = [];
  }

  BookingWeeklyListResponse.fromJson(var jsonObject) {
    for (var area in jsonObject) {
      BookingWeeklyReadResponse model =
          BookingWeeklyReadResponse.fromJson(area);
